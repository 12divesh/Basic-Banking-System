package com.example.basicbankingapp.UI.DB;
...
public class UserHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // Insert Into Table
        db.execSQL("insert into " + TABLE_NAME + " values(7862,'Divesh Sisodiya', 'malviyadivesh31@gmail.com','7583','7895641238', 15000)");
